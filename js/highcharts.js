...
(function (X, N) {
            ...
            e.prototype.updateBoxSize = function () {
                ...
                this.needsBox &&
                    (this.box ||
                        ...
                        f.addClass(("button" === this.className ? "" : "highcharts-label-box") + (this.className ? " highcharts-" + this.className + "-box" : "")),
                        f.add(this),
    ...
    N(m, "Core/Options.js", [m["Core/Globals.js"], m["Core/Color/Color.js"], m["Core/Time.js"], m["Core/Utilities.js"]], function (f, h, m, z) {
        ...
        f.defaultOptions = {
            ...
            credits: { enabled: !0, href: "https://www.saifpowertecltd.com?credits", position: { align: "right", x: -10, verticalAlign: "bottom", y: -5 }, style: { cursor: "pointer", color: "#999999", fontSize: "9px" }, text: "" },
        };
        ("");
            ...
            u.prototype.getOffset = function () {
                ...
                b.axisGroup ||
                    ...
                    (b.labelGroup = c
                        ...
                        .addClass("highcharts-" + b.coll.toLowerCase() + "-labels " + (v || ""))
                        .add(O)));
                D || b.isLinked
                        ...
                        f &&
                            q.forEach(function (c, k) {
                                ...
                                0 === k % 2 &&
                                    ...
                                    (E = c + A),
                                    (r[c].options = { from: d ? d.lin2log(E) : E, to: d ? d.lin2log(v) : v, color: f, className: "highcharts-alternate-grid" }),
                                    r[c].render(),
                                    (r[c].isActive = !0));
                            }),
                        b._addedPlotLB ||
                ...
                if (this.crosshair && !1 !== (x(a) || !k)) {
                    ...
                    g ||
                        ((this.cross = g = p.renderer
                            .path()
                            .addClass("highcharts-crosshair highcharts-crosshair-" + (k ? "category " : "thin ") + c.className)
    ...
    N(m, "Core/Axis/PlotLineOrBand.js", [m["Core/Axis/Axis.js"], m["Core/Globals.js"], m["Core/Utilities.js"]], function (f, h, m) {
        ...
        m = (function () {
            ...
            f.prototype.renderLabel = function (e, f, l, h) {
                ...
                n ||
                    ((n = { align: e.textAlign || e.align, rotation: e.rotation, class: "highcharts-plot-" + (l ? "band" : "line") + "-label " + (e.className || "") }),
                    (n.zIndex = h),
                    ...
                    !1 === c
                        ...
                        : (this.split
                              ...
                              : ((d = this.getLabel()),
                                ...
                                d.removeClass(/highcharts-color-[\d]+/g).addClass("highcharts-color-" + D(q.colorIndex, f.colorIndex)),
                    ...
                    if (!1 !== p && "" !== p) {
                        ...
                        B ||
                            ...
                            (B = h
                                ...
                                .addClass((A ? "highcharts-tooltip-header " : "") + "highcharts-tooltip-box " + E)
                                .attr(B)
                                .add(x)));
                        B.isActive = !0;
                        B.attr({ text: p });
            ...
            g = (function () {
                ...
                c.prototype.renderItem = function (a) {
                    ...
                    v ||
                        ((a.legendGroup = d
                            .g("legend-item")
                            .addClass("highcharts-" + b.type + "-series highcharts-color-" + a.colorIndex + (H ? " " + H : "") + (u ? " highcharts-series-" + a.index : ""))
                            .attr({ zIndex: 1 })
                ...
                c.prototype.scroll = function (a, c) {
                    ...
                    0 < l &&
                        ...
                        [this.up, this.upTracker].forEach(function (a) {
                            a.attr({ class: 1 === l ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active" });
                        }),
                        r.attr({ text: l + "/" + f }),
                        [this.down, this.downTracker].forEach(function (a) {
                            a.attr({ x: 18 + this.pager.getBBox().width, class: l === f ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active" });
                        }, this),
                        g.styledMode ||
    ...
    N(m, "Extensions/ScrollablePlotArea.js", [m["Core/Animation/AnimationUtilities.js"], m["Core/Chart/Chart.js"], m["Core/Globals.js"], m["Core/Utilities.js"]], function (f, h, m, z) {
        ...
        h.prototype.setUpScrolling = function () {
            ...
            this.innerContainer = K("div", { className: "highcharts-inner-container" }, null, this.scrollingContainer);
        ...
        h.prototype.moveFixedElements = function () {
            ...
            this.scrollablePixelsX && !this.inverted
                ...
                ? (m = ".highcharts-xaxis")
                : this.scrollablePixelsY && this.inverted && (m = ".highcharts-yaxis");
            h.push(m, m + "-labels");
        ...
        h.prototype.applyFixed = function () {
            ...
            h
                ? ((this.fixedDiv = K("div", { className: "highcharts-fixed" }, { position: "absolute", overflow: "hidden", pointerEvents: "none", zIndex: 2, top: 0 }, null, !0)),
                ...
                },
                {
                    ...
                    setOptions: function (a) {
                        ...
                        (!f.negativeColor && !f.negativeFillColor) ||
                            f.zones ||
                            ((d = { value: f[this.zoneAxis + "Threshold"] || f.threshold || 0, className: "highcharts-negative" }), b || ((d.color = f.negativeColor), (d.fillColor = f.negativeFillColor)), c.push(d));
        ...
        function (f, h, m, z, F, L, K, C, y, e) {
            ...
            g(z.prototype, {
                ...
                showLoading: function (a) {
                    ...
                    b || ((c.loadingDiv = b = l("div", { className: "highcharts-loading highcharts-loading-hidden" }, null, c.container)), (c.loadingSpan = l("span", { className: "highcharts-loading-inner" }, null, b)), n(c, "redraw", f));
                            ...
                            ? b &&
                              ...
                              (k
                                  ...
                                  : ((g.dataLabels = g.dataLabels || []),
                                    (k = g.dataLabels[h] = A ? C.text(u, 0, -9999, e.useHTML).addClass("highcharts-data-label") : C.label(u, 0, -9999, e.shape, null, null, e.useHTML, null, "data-label")),
                                    h || (g.dataLabel = k),
                                    k.addClass(" highcharts-data-label-color-" + g.colorIndex + " " + (e.className || "") + (e.useHTML ? " highcharts-tracker" : ""))),
                              (k.options = e),
                              k.attr(w),
                ...
                if (d) {
                    ...
                    d.oldOpacity !== f &&
                        (d.alignAttr && d.placed
                            ? (d[f ? "removeClass" : "addClass"]("highcharts-data-label-hidden"),
                              (l = !0),
                    ...
                    if (!((a === this.state && !c) || (this.selected && "select" !== a) || !1 === f.enabled || (a && (n || (h && !1 === p.enabled))) || (a && b.states && b.states[a] && !1 === b.states[a].enabled))) {
                        ...
                        a && a.size && m && "hidden" !== f && !this.isCluster
                            ? (r || (d.halo = r = k.renderer.path().add(m.parentGroup)),
                              ...
                              r.attr({ class: "highcharts-halo highcharts-color-" + q(this.colorIndex, d.colorIndex) + (this.className ? " " + this.className : ""), visibility: f, zIndex: -1 }),
                              (r.point = this),
