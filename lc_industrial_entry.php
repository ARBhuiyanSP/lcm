        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Lc Entry - [Industrial]</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
			...
			<div class="col-md-12">
				<div class="card">
						...
						<div class="row">
							<div class="col-md-1">
								<div class="form-group">
								  <label>SL No</label>
								  <input class="form-control" type="text" name="sl_no" readonly value="<?php echo getDefaultCategoryCode('lc_industrial', 'sl_no', '03d', '001', 'LCI-') ?>" />
								</div>
								<!-- /.form-group -->
							</div>
							<!-- /.col -->
							...
							<div class="col-md-3">
								<div class="form-group">
								  ...
								  <input class="form-control" type="text" name="applicant_address" />
								</div>
								<!-- /.form-group -->
							</div>
							<!-- /.col -->
							...
							<div class="col-md-6">
								<div class="form-group">
								  <label>Restricted items showing individual share</label>
								  <textarea id="summernote2" name="restricted_items"> </textarea>
								</div>
								<!-- /.form-group -->
							</div>
							<!-- /.col -->
					...
					<div class="card-footer">
					  <input type="submit" name="industrial_submit" id="industrial_submit" class="btn btn-info btn-block btn-sm" style="" value="SAVE LC" />
					</div>
					</form>
				</div>
				<!-- /.card -->
