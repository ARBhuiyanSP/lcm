...
<div class="card mb-3">
    <div class="card-header">
        ...
        Individual Consumption Report 
		<button class="btn btn-info" onclick="window.location.href='consumption_group_report.php';"> Material Groupwise Consumption Report</button>
