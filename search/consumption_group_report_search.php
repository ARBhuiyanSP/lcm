...
<div class="card mb-3">
    <div class="card-header">
        ...
        Material Groupwise Consumption Report 
		<button class="btn btn-info" onclick="window.location.href='consumption_report.php';"> Individual Consumption Report</button>
