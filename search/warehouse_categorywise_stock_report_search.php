...
<div class="card mb-3">
    <div class="card-header">
		<button class="btn btn-info" onclick="window.location.href='stock_report.php';"> Stock Report</button>
		...
		<button class="btn btn-default"> Warehouse Categorywise Stock Report </button>
	</div>
    <div class="card-body">
