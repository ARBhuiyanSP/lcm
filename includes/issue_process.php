		...
		$_SESSION['warning']    =   "Operation faild. Duplicate data found..!";
			...
			for ($count = 0; $count < count($_POST['quantity']); $count++) {
				...
				*/       
				...
				$query = "INSERT INTO `inv_issuedetail` (`issue_id`,`issue_date`,`material_id`,`material_name`,`unit`,`issue_qty`,`issue_price`,`part_no`,`project_id`,`warehouse_id`,`package_id`,`building_id`) VALUES ('$issue_id','$issue_date','$material_id','$material_name','$unit','$quantity','$unit_price','$part_no','$project_id','$warehouse_id','$package_id','$building_id')";
				$conn->query($query);
